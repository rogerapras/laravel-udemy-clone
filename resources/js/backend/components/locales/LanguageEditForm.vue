<template>
    <tr>
        ...
        <td class="d-flex">
            ...
            <div class="custom-control custom-checkbox mr-3 font-14 fw-300">
                <input :id="`is_active${language.id}`" name="is_active" :value="true" v-model="form.is_active" class="custom-control-input" type="checkbox">
                <label class="custom-control-label" :for="`is_active${language.id}`">
                    {{ trans('strings.is_active') }}
                </label>
            </div>
            <div class="custom-control custom-checkbox mr-3 font-14 fw-300">
                <input :id="`is_rtl${language.id}`" name="is_rtl" :value="true" v-model="form.is_rtl" class="custom-control-input" type="checkbox">
